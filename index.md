...
I am an Assistant Professor in the Department of Epidemiology and Biostatistics at the University of California, San Francisco.
...
## News
- **Apr 2022**: I gave a talk at the Biometrics Jounral Club on the statistical considerations when regulating ML-based medical devices that are evolving/updated over time. The talk is based on our 2021 Biometrics paper "Approval policies for modifications to machine learning-based software as a medical device: A study of bio-creep". Slides are [here](https://www.jeanfeng.com/biometrics_talk.pdf).
